...
public class EDCrypt {
    ...
    public String encrypt(String secretKey, String text) throws NoSuchAlgorithmException,
    ...
    public static void main(String[] args) {
        ...
        try {
            String encrypt = crypt.encrypt("JavaInstitute", "1234");
            System.out.println(encrypt);
            //String decrypt = crypt.decrypt("JavaInstitute", "L/eUZIk+tpQ=");
